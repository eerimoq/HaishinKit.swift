    ...
    public class IOUIScreenCaptureUnit: NSObject, IOScreenCaptureUnit {
        ...
        /// Specifies the boolean value that indicates whether the snapshot should be rendered after recent
        ...
        private let lockQueue = DispatchQueue(
            label: "com.haishinkit.HaishinKit.ScreenCaptureSession.lock", qos: .userInteractive,
            attributes: []
        )
        ...
        func onScreenProcess(_ displayLink: CADisplayLink) {
            ...
            delegate?.session(
                ...
                presentationTime: CMTimeMakeWithSeconds(displayLink.timestamp, preferredTimescale: 1000)
            )
