import AVFoundation
    ...
    public enum DeviceUtil {
        ...
        public static func videoOrientation(by orientation: UIDeviceOrientation)
        ...
        public static func videoOrientation(by orientation: UIInterfaceOrientation)
            -> AVCaptureVideoOrientation?
        {
            switch orientation {
            case .portrait:
        ...
        public static func isHeadphoneConnected(_ ports: Set<AVAudioSession.Port> = [
            .headphones,
            .bluetoothLE,
            .bluetoothHFP,
            .bluetoothA2DP,
        ...
        public static func isHeadphoneDisconnected(
            _ notification: Notification,
            ports: Set<AVAudioSession.Port> = [.headphones, .bluetoothLE, .bluetoothHFP, .bluetoothA2DP]
        ) -> Bool {
            guard let previousRoute = notification
